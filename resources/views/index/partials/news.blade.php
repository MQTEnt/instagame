			...
			<div class="row">
				<div class="col-sm-6 col-md-6">
					...
					<div class="testimonialslide clearfix flexslider">
						<ul class="slides">
							<li>
								<blockquote>Usu ei porro deleniti similique</blockquote>
				...
				<div class="col-sm-6 col-lg-6">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#one" data-toggle="tab">
							<i class="icon-briefcase"></i> One</a>
						</li>
						<li>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="one">
							<p>
								<img src="img/index/dummy1.jpg" class="pull-left" alt="" />
								<strong>Augue iriure</strong> dolorum per ex, ne iisque ornatus veritus duo. Ex nobis integre lucilius sit, pri ea falli ludus appareat
							</p>
							<p>
						...
						<div class="tab-pane" id="two">
							<p>
								<img src="img/index/dummy1.jpg" class="pull-right" alt="" />
							...
							<p>
								Lorem ipsum dolor sit amet, vel laoreet pertinacia at, nam ea ornatus ocurreret gubergren. Per facete graecis eu.
							</p>
						</div>
